      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            منصة عمرة هي أول منصة إلكترونية متكاملة في المملكة العربية السعودية متخصصة في تجميع شركات العمرة المعتمدة تحت مظلة واحدة، لتسهيل عملية البحث والحجز على العملاء.
          </p>
        </div>
